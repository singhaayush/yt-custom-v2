...
import com.example.ytcustomv2.player.YouTubePlayerBridge
...
import com.example.ytcustomv2.player.utils.Utils
...
internal class WebViewYouTubePlayer constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0)
    ...
    private val youTubePlayerListeners = java.util.HashSet<YouTubePlayerListener>()
